// chọn cấp độ học - Neo Brutalism Design
...
function LevelPage() {
  ...
  // Levels with translation keys
  const levels = [
    { id: 'n1', titleKey: 'level.n1Title', descKey: 'level.n1Desc', bgColor: '#FF0080' },
    { id: 'n2', titleKey: 'level.n2Title', descKey: 'level.n2Desc', bgColor: '#00D9FF' },
    { id: 'n3', titleKey: 'level.n3Title', descKey: 'level.n3Desc', bgColor: '#FFD600' },
    { id: 'n4', titleKey: 'level.n4Title', descKey: 'level.n4Desc', bgColor: '#00FF94' },
    ...
    <div className="w-full pr-0 md:pr-4">
      ...
      <div className="mt-4 w-full">
        ...
        <div className="bg-white rounded-lg border-[4px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex flex-col w-full min-h-app">
          ...
          {/* ========== LEVEL CARDS - Neo Brutalism Design ========== */}
          <div className="p-4 sm:p-5 md:p-6">
            <div className="flex flex-col gap-4">
              ...
              {/* Row 2: N3 | N4 */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {levels.slice(2, 4).map((level, index) => {
                  const hasLevelAccess = accessMap[level.id];
                  return (
                    <div 
                      key={level.id} 
