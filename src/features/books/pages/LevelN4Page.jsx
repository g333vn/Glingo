    ...
    useEffect(() => {
        const loadBooks = async () => {
            ...
            if (cleanedSaved && cleanedSaved.length > 0) {
                setN4Books(cleanedSaved);
                await storageManager.saveBooks('n4', cleanedSaved);
                console.log(`✅ Loaded ${cleanedSaved.length} N4 books (demo/extra removed)`);
            } else {
