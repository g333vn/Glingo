// trang chọn level thi thử - REDESIGNED LIKE LEVEL PAGE
...
const jlptLevels = [
  { id: 'n1', title: 'N1 - Cao cấp', description: 'Thi thử N1', imageUrl: '/jlpt-buttons/n1-icon.jpg', colorClass: 'from-red-100 to-red-300 text-red-800' },
  { id: 'n2', title: 'N2 - Trung cao cấp', description: 'Thi thử N2', imageUrl: '/jlpt-buttons/n2-icon.jpg', colorClass: 'from-orange-100 to-orange-300 text-orange-800' },
  { id: 'n3', title: 'N3 - Trung cấp', description: 'Thi thử N3', imageUrl: '/jlpt-buttons/n3-icon.jpg', colorClass: 'from-yellow-100 to-yellow-300 text-yellow-800' },
  { id: 'n4', title: 'N4 - Sơ cấp', description: 'Thi thử N4', imageUrl: '/jlpt-buttons/n4-icon.jpg', colorClass: 'from-green-100 to-green-300 text-green-800' },
  { id: 'n5', title: 'N5 - Cơ bản', description: 'Thi thử N5', imageUrl: '/jlpt-buttons/n5-icon.jpg', colorClass: 'from-blue-100 to-blue-300 text-blue-800' },
];
    ...
    <div className="w-full pr-0 md:pr-4 flex flex-col md:flex-row">
      ...
      <div className="flex flex-col md:flex-row items-start gap-0 md:gap-6 mt-4 w-full">
        ...
        <div className="flex-1 min-w-0 bg-gray-100/90 backdrop-blur-sm rounded-lg shadow-lg flex flex-col w-full min-h-app">
          ...
          {/* ========== JLPT LEVEL CARDS - 5 NGANG, ĐỀU NHAU, 220px ========== */}
            ...
            <div className="w-full flex flex-col md:flex-row items-stretch gap-6 bg-gradient-to-br from-white via-blue-50/30 to-white rounded-xl shadow-inner border-2 border-gray-200 p-6 overflow-hidden">
              ...
              <div className="flex-1 flex flex-col justify-center text-center md:text-left space-y-4 py-2">
                ...
                <blockquote className="text-lg md:text-xl font-serif italic text-gray-800 leading-relaxed border-l-4 border-blue-400 pl-5 py-2 bg-white/50 rounded-r-lg">
                  "The only way to avoid making mistakes is to do nothing. But that is the biggest mistake of all."
                </blockquote>

                {/* Quote tiếng Anh - Complementary */}
                <p className="text-base md:text-lg text-gray-700 leading-relaxed font-medium pl-5">
                  "間違いを避ける唯一の方法は、何もしないことだ。しかし、それは最大の間違いでもある。"
                </p>
