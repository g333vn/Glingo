        ...
        <div className="px-6 md:px-10 pb-10 space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center gap-2">
              <span className="text-orange-500">1.</span> {t('legal.terms.acceptance.title')}
            </h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center gap-2">
              <span className="text-orange-500">2.</span> {t('legal.terms.service.title')}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center gap-2">
              <span className="text-orange-500">3.</span> {t('legal.terms.account.title')}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center gap-2">
              <span className="text-orange-500">4.</span> {t('legal.terms.prohibited.title')}
            </h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center gap-2">
              <span className="text-orange-500">5.</span> {t('legal.terms.ip.title')}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center gap-2">
              <span className="text-orange-500">6.</span> {t('legal.terms.disclaimer.title')}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center gap-2">
              <span className="text-orange-500">7.</span> {t('legal.terms.termination.title')}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-3 flex items-center gap-2">
              <span className="text-orange-500">8.</span> {t('legal.terms.contact.title')}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
