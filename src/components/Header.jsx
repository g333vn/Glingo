        ...
        <nav className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          ...
          >
            <img
              ...
              `}
            />
            {/* Logo text - Compact trên tablet, full trên desktop */}
            <span className="font-bold text-xs sm:text-sm md:text-sm lg:text-base xl:text-xl text-white whitespace-nowrap transition-all duration-500 group-hover:text-yellow-300">
              <span className="md:hidden">Learn Your Approach</span>
              <span className="hidden md:inline lg:hidden">Learn</span>
              <span className="hidden lg:inline">Learn Your Approach</span>
            </span>
          </button>

          {/* Desktop Links với Enhanced Effects - Tablet: gap vừa phải, Desktop: gap lớn */}
          <div className="hidden md:flex items-center gap-2 md:gap-3 lg:gap-4 xl:gap-6 2xl:gap-8">
            {/* Home */}
            <button
              onClick={() => handleNavigate('/')}
            ...
            {/* About - Compact trên tablet, full trên desktop */}
            <button
              onClick={() => handleNavigate('/about')}
              className={`${getLinkClass('/about')} bg-transparent border-none cursor-pointer font-medium text-xs md:text-sm lg:text-base`}
            >
              <span className="md:hidden lg:inline">ABOUT ME</span>
            ...
            {user ? (
              <div className="flex items-center gap-1.5 md:gap-2 lg:gap-2.5 xl:gap-3">
                ...
                {isAdmin() && (
                  ...
                  >
                    <span>⚙️</span>
                    <span className="hidden md:inline lg:hidden">Admin</span>
                    <span className="hidden lg:inline">Admin Panel</span>
                  </button>
                )}
                  <div className="flex items-center gap-1.5 md:gap-2 px-2 md:px-3 py-1.5 md:py-2 bg-yellow-400/10 rounded-lg border border-yellow-400/30">
                    <span className="text-yellow-400 text-xs md:text-sm font-medium truncate max-w-[80px] md:max-w-[100px] lg:max-w-none">
