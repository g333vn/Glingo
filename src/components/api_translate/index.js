// src/components/api_translate/index.js
// Export tất cả components và hooks liên quan đến tra từ

export { DictionaryProvider, useDictionary } from './DictionaryContext.jsx';
